    ...
    <body>
        ...
        <section class="registro">
            <div class="container mi_container">
                ...
                $sql = "INSERT INTO usuarios (nombre, apellidos, correo, contrasena, id) VALUES (?, ?, ?, ?, ?)";

                $stmt = $conex->prepare($sql);

                if($stmt->execute([$nombre, $apellidos, $correo, $pass, $id]) == FALSE){
                    echo '                <div class="registro_cabecera">
                    <p class="titulo">Ha ocurrido un error</p>
                    <div class="linea_horizontal"></div>
                    <p class="centrado">
                        Pulse&nbsp;<a href="../index.php">aquí</a> &nbsp;para volver a la página principal
                    </p>
                </div>';
                } else{
                    echo '                <div class="registro_cabecera">
                    <p class="titulo">Ha sido registrado con éxito.</p>
                    <div class="linea_horizontal"></div>
                    <p class="centrado">
                        Pulse&nbsp;<a href="inicio.php">aquí</a> &nbsp;para iniciar sesión.
                    </p>
                </div>';
                }
