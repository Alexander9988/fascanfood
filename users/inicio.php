    ...
    <body>
        ...
        <section class="inicio">
            <div class="container mi_container">
                ...
                <form action="inicio_ok.php" method="post" class="formulario_inicio">
                    <div class="form-group">
                        ...
                        <p class="alerta_correo">&nbsp;*No has rellenado este campo</p>
                    </div>
                    <div class="form-group">
                        ...
                        <p class="alerta_pass">&nbsp;*No has rellenado este campo</p>

                    </div>
                    <button type="submit" id="btn_inicio" class="btn btn_registro hvr-shutter-out-horizontal">Enviar</button>
                </form>
