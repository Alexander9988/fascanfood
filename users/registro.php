...
<html lang="es">  
    <head>    
        ...
        <title>Registro - Fascanfood</title>
    ...
    <body>
        ...
        <section class="registro">
            <div class="container mi_container">
                ...
                <div class="registro_cabecera">
                    <p class="titulo">Crear usuario</p>
                    <div class="linea_horizontal"></div>
                </div>

                <form action="registro_ok.php" method="post" class="formulario_registro">
                    <div class="form-group">
                        <label for="reg_usuario_nombre">Nombre</label>
                        <input type="text" class="form-control" id="reg_usuario_nombre" name="usuario_nombre" placeholder="Nombre">
                        <p class="alerta_reg_nombre">&nbsp;*No has rellenado este campo</p>
                    </div>
                    <div class="form-group">
                        <label for="reg_usuario_apellidos">Apellidos</label>
                        <input type="text" class="form-control" id="reg_usuario_apellidos" name="usuario_apellidos" placeholder="Apellidos">
                        <p class="alerta_reg_apellidos">&nbsp;*No has rellenado este campo</p>
                    </div>
                    <div class="form-group">
                        <label for="reg_usuario_correo">Correo electrónico</label>
                        <input type="email" class="form-control" id="reg_usuario_correo" name="usuario_correo" placeholder="Correo electrónico">
                        <p class="alerta_reg_correo">&nbsp;*No has rellenado este campo</p>
                    </div>
                    <div class="form-group">
                        <label for="reg_usuario_pass">Contraseña</label>
                        <input type="password" class="form-control" id="reg_usuario_pass" name="usuario_pass" placeholder="Contraseña">
                        <p class="alerta_reg_pass">&nbsp;*No has rellenado este campo</p>
                    </div>
                    <div class="form-group">
                        <label for="reg_usuario_pass_con">Confirmar constraseña</label>
                        <input type="password" class="form-control" id="reg_usuario_pass_con" name="usuario_pass_con" placeholder="Confirmar contraseña">
                        <p class="alerta_reg_pass_con">&nbsp;*No has rellenado este campo</p>
                        <p class="alerta_reg_pass_con2">&nbsp;*Las contraseñas no coinciden</p>
                    </div>
                    <button type="submit" id="btn_registro" class="btn btn_registro hvr-shutter-out-horizontal">Enviar</button>
                </form>

                <p class="centrado">Si ya tiene una cuenta, inicie sesión<a href="inicio.php">&nbsp;aquí</a></p>
            </div>
        </section>
