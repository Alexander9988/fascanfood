...
<html lang="es">  
    <head>    
        ...
        <title>Comprar - Fascanfood</title>
        ...
        <script src="../js/scripts-sesiones.js" type="text/javascript"></script>
    ...
    <body>
        ...
        <section class="compra">
            <div class="container mi_container">
                ...
                <div class="compra_cabecera">
                    <p class="titulo">Datos de la compra</p>
                    <div class="linea_horizontal"></div>
                </div>

                <form action="compra_ok.php" method="post" class="formulario_compra">
                    <div class="form-group">
                        <label for="usuario_direccion">Dirección</label>
                        <input type="text" class="form-control" id="usuario_direccion" name="usuario_direccion" placeholder="Dirección, domilicio...">
                        <p class="alerta_direccion">&nbsp;*No ha rellenado este campo</p>
                    </div>
                    <div class="form-group">
                        <label for="usuario_tfn">Teléfono de contacto</label>
                        <input type="number" class="form-control" id="usuario_tfn" name="usuario_tfn" placeholder="Teléfono móvil">
                        <p class="alerta_tfn">&nbsp;*No ha rellenado este campo</p>
                    </div>
                    <div class="form-group">
                        ...
                        <p class="alerta_metodo">&nbsp;*No ha seleccionado ningún método</p>
                    </div>

                    <button type="submit" id="btn_compra" class="btn btn_registro hvr-shutter-out-horizontal">Enviar</button>
                </form>
