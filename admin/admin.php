    ...
    <body>
                            ...
                            <div class="collapse navbar-collapse animacion" id="bs-example-navbar-collapse-1">
                                <div class="navbar-right carrito animacion hidden-xs">
                                    ...
                                    if(!isset($_SESSION["nombre"])){
                                        ...
                                        echo '
                                        <div class="carrito_mensaje grande animacion">
                                        <div class="carrito_mensaje_triangulo"></div>
                                            <p>Vea la información de su carro <a href="carrito.php">aquí</a></p>

                                            <p>O pulse <a href="logout.php">aquí</a> para cerrar sesión</p></div>';
                                    }
                                ...
                                <div class="navbar-right carrito animacion">
                                    ...
                                    if(!isset($_SESSION["nombre"])){
                                        echo '
                                            <div class="carrito_mensaje animacion">
                                        <div class="carrito_mensaje_triangulo"></div>
                                            <p>No has iniciado sesión aún. Hazlo <a href="users/inicio.php">aquí</a></p>
                                            </div>';
                                    } else {
                                        echo '
                                        <div class="carrito_mensaje grande animacion">
                                        <div class="carrito_mensaje_triangulo"></div>
                                            <p>Vea la información de su carro <a href="users/carrito.php">aquí</a></p>

                                            <p>O pulse <a href="users/logout.php">aquí</a> para cerrar sesión</p></div>';
                                    }
                                    ?>
                                </div>
        ...
        <section class="admin">
            ...
            <div class="container">
                ...
                <p class="titulo">Verifíquese</p>
                <div class="linea_horizontal"></div>

                <form action="scripts/verificar_admin.php" method="post">


                    <div class="form-group">
                        <label for="admin_correo">Correo electrónico</label>
                        <input type="email" class="form-control" id="admin_correo" name="admin_correo" placeholder="Correo administrador">
                    </div>

                    <div class="form-group">
                        <label for="admin_pass">Correo electrónico</label>
                        <input type="password" class="form-control" id="admin_pass" name="admin_pass" placeholder="Contraseña administrador">
                    </div>

                    <p class="alerta_admin">&nbsp;*No has rellenado todos los campos</p>


                    <button type="submit" id="btn_admin" class="btn btn_admin hvr-shutter-out-horizontal">Enviar</button>
